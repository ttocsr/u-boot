...
/* Default Env vars */
#define CONFIG_IPADDR			192.168.1.5	/* In order to cause an error */
#define CONFIG_SERVERIP			192.168.1.230	/* In order to cause an error */
...
#define CONFIG_EXTRA_ENV_SETTINGS	"kernel_addr=0x2000000\0"	\
					...
					"mtdparts=spi0.0:5m(Bootloader),5m(Kernel),2m(DeviceTreeBlob),32m(RootFileSystem)\0"	\
